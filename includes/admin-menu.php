...
class Post_Management_Admin_Menu{
    ...
    public function admin_menu () {
        add_menu_page( 'Post Management', 'Post Management', 'manage_options', 'post-managements', array($this,'custom_post_menu'), 'dashicons-chart-pie', 2 );
    }

    public function custom_post_menu () {
